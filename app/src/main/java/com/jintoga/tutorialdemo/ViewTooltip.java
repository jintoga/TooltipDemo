...
public class ViewTooltip {
    ...
    private ViewTooltip(MyContext myContext, View view) {
        this.view = view;
        this.bgView = new View(myContext.getContext());
        ...
        if (activityContext instanceof Activity) {
            ...
            view.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    bgView.setBackground(new ColorDrawable(ContextCompat.getColor(activityContext, R.color.black_50)));
                    bgView.setFocusableInTouchMode(true);
                    bgView.setFocusable(true);
                    bgView.setClickable(true);

                    decorView.addView(bgView, ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
    ...
    public static class TooltipView extends FrameLayout {
        ...
        public void setupPosition(Rect rect, int screenWidth) {
            ...
            if (rect.left < halfScreen) {
                setTranslationX(x + 100);
            } else if (rect.right > halfScreen) {
                setTranslationX(x - 100);
            } else {
                setTranslationX(x);
            }
